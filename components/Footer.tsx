    ...
    <footer className="bg-[var(--brand-bg)] border-t border-white/[0.06]">
      ...
      <div className="max-w-[1320px] mx-auto px-6 py-14">
        <div className="flex flex-col tablet:flex-row justify-between gap-10">
          ...
          <div className="flex-1 max-w-xs">
            ...
            <div className="space-y-2 text-[14px] font-light text-[var(--n-500)] leading-relaxed">
          ...
          <div className="flex-1">
            ...
            <nav className="space-y-3 text-[14px]">
              <a
                href="#reservation"
                className="block font-light text-[var(--n-400)] transition-colors duration-300 hover:text-white"
              >
                방문상담 예약
              </a>
              <a
      ...
      <div className="border-t border-white/[0.05] py-6 px-6">
        <div className="max-w-[1320px] mx-auto flex flex-col tablet:flex-row justify-between items-start tablet:items-center gap-2">
          <p className="text-[12px] font-light text-[var(--n-600)]">
            &copy; {new Date().getFullYear()} {siteName || "Brand Apartment"}. All rights
            reserved.
          </p>
          <p className="text-[12px] font-light text-[var(--n-700)]">
